// Generated by scripts/extract-theme-values.mjs from src/styles/theme.css.
...
// without a browser. Every value here is resolved from src/styles/theme.css, so the
