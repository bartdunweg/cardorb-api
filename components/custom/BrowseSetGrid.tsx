    ...
    <div className="flex flex-col gap-6 pb-[var(--page-pad-bottom)]">
      <div className="flex flex-wrap items-center gap-x-5 gap-y-3">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          ...
          <p className="font-body text-xs text-secondary m-0 tabular-nums">
        ...
        >
          {shown.map((card) => (
            <li key={card.id} className="flex flex-col gap-[2px] min-w-0">
              ...
              <span
                className="flex items-baseline gap-2 font-body
              ...
              {card.owned ? (
                <span className="font-body text-xs font-semibold text-secondary tabular-nums">
                  In your collection{card.quantity > 1 && ` · ${n(card.quantity)}×`}
                </span>
              ) : card.wishlist ? (
                <span className="font-body text-xs font-semibold text-tertiary">
                  On your wishlist
                </span>
              ) : (
                <button
