    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
        ...
        {/* The plus that used to sit in the middle of the mobile tab bar. It
            left so the bar's four slots could be one equal width (ADR-0085),
      ...
      <ul className="list-none m-0 p-0 flex flex-col gap-2" role="list">
        {rows.map((row) => (
          ...
          >
            ...
            <span className="h-[10px] rounded-orb-sm bg-secondary overflow-hidden">
              <span
                className="block h-full bg-brand-solid [border-radius:0_4px_4px_0]"
