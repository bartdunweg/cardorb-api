...
| ------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Our bucket (Cloudflare R2 `cardorb-images`) | https://images.cardorb.com                            | Every copied English card picture                                                       | The browser loads it, through Vercel's image optimizer; edge cached         |
...
| TCGdex assets                               | https://assets.tcgdex.net                             | Card scans (`low.webp`, `high.webp`), set logos and symbols                             | Scans: copied by the catalogue cron. Logos, and Japanese scans: loaded live |
| Limitless                                   | https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com  | A scan TCGdex lacks, by set code; Japanese scans                                        | Catalogue cron; Japanese live through `/api/cover` (no CORS there)          |
