...
beforeEach(() => {
  vi.clearAllMocks();
  ownerOf.mockResolvedValue({ id: "u", username: "bart", displayName: "Bart", avatarUrl: null, wishlistPublic: false, favoritesPublic: false, pokedexPublic: false, pokedex: null });
