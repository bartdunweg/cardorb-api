...
describe("createRow", () => {
  ...
  /* The number is settled before the write, by withCatalogueSpelling(): the card's printed number
     where the copy holds the card, the old stored form where it does not (catalogue-spelling.ts,
     migration 20260920160000). What arrives here is written as it arrives, prefix and all. */
