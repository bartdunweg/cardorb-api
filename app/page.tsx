    ...
    <section className="page-signin">
      <Card className="signin-card">
        {/* The heading says what this screen is for, not what the app is
            called. It was "binder" with a line under it explaining that you
            sign in to add to the collection — a title that named the product
            and a subtitle doing the title's job. One line says both. */}
        <h1 className="page-title">Sign in to binder</h1>
        <SignInForm redirectTo={next} defaultEmail={process.env.OWNER_EMAIL ?? ""} />

        {/* Something for the people this login is not for. Without it the root
            of the app is a locked door with no sign, which is a strange thing
            to find at the end of a link someone shared.
